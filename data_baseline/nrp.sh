...
export NRPLOGDIR=/users/bp000193/nestserver_benchmarks/test333/nrplogs
...
sarus run \
	  ...
	  sed -i 's|NestClientControlAdapter()|NestClientControlAdapter(\"nid01412\", 5000)|' $NRPSRCSERV/server/ServerConfigurations.py;
          \
